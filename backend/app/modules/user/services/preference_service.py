...
from app.modules.user.repositories.user_preference_repository import UserPreferenceRepository
from app.modules.user.schemas.user import PreferencesUpdateRequest
