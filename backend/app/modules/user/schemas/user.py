...
class UserResponse(PetVerseBaseModel):
...
class ProfileReplaceRequest(PetVerseBaseModel):
...
class ProfileUpdateRequest(PetVerseBaseModel):
...
class AvatarResponse(PetVerseBaseModel):
...
class PreferencesResponse(PetVerseBaseModel):
...
class PreferencesUpdateRequest(PetVerseBaseModel):
...
class PrivacyResponse(PetVerseBaseModel):
...
class PrivacyUpdateRequest(PetVerseBaseModel):
...
class AccountActionRequest(PetVerseBaseModel):
    """
