...
class Pet(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    medical_records: Mapped[list["MedicalRecord"]] = relationship("MedicalRecord", back_populates="pet", cascade="all, delete-orphan", lazy="selectin")  # type: ignore
    vaccinations: Mapped[list["Vaccination"]] = relationship("Vaccination", back_populates="pet", cascade="all, delete-orphan", lazy="selectin")  # type: ignore
    medications: Mapped[list["Medication"]] = relationship("Medication", back_populates="pet", cascade="all, delete-orphan", lazy="selectin")  # type: ignore
    weight_histories: Mapped[list["WeightHistory"]] = relationship("WeightHistory", back_populates="pet", cascade="all, delete-orphan", lazy="selectin")  # type: ignore
    health_documents: Mapped[list["HealthDocument"]] = relationship("HealthDocument", back_populates="pet", cascade="all, delete-orphan", lazy="selectin")  # type: ignore
