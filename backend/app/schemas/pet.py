...
class PetCreateRequest(_PetFieldValidators, BaseModel):
...
class PetReplaceRequest(_PetFieldValidators, BaseModel):
...
class PetUpdateRequest(_PetFieldValidators, BaseModel):
...
class PetProfileImageResponse(BaseModel):
    model_config = ConfigDict(from_attributes=True)

    profile_image: Optional[str] = None


class PetCoverImageResponse(BaseModel):
    model_config = ConfigDict(from_attributes=True)

    cover_image: Optional[str] = None


class PetGalleryImageResponse(BaseModel):
    model_config = ConfigDict(from_attributes=True)
